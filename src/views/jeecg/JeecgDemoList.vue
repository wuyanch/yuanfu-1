        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="业务经理姓名">
              <j-input placeholder="请输入业务经理姓名模糊查询" v-model="queryParam.realname"></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="所属人员机构道">
                <a-select
                  v-model="queryParam.organization"
                  placeholder="请选择机构"
                >
            ...
            <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-select v-model="queryParam.organization" default-value="lucy" style="width: 120px" @change="handleChange">
            ...
            <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="所在机构">
                <j-dict-select-tag v-model="queryParam.organization" placeholder="请选择机构" dictCode="organization"/>
              </a-form-item>
            </a-col> -->
            <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="所属人员渠道">
                <j-dict-select-tag v-model="queryParam.id" placeholder="请选择渠道" dictCode="organization,id"/>
              </a-form-item>
            </a-col> -->
          </template>
